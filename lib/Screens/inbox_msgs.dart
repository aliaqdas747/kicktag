...
class ChatScreen extends StatelessWidget {
  final List<Map<String, dynamic>> inboxMsgs = [
    ...
    {'message': 'How was your UI/UX Design Course Like? 😊', 'isMe': true, 'time': '10:47'},
    {'message': 'Hi, Morning too Ronald', 'isMe': false, 'time': '11:22'},
    {'message': 'Hello, I also just finished the Sketch Basic ⭐⭐⭐⭐⭐', 'isMe': false, 'time': '11:42'},
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> const AffliateDashboard()));
                    },
                  ),
                  Container(
